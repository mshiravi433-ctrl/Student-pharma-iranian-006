...
- `GET  /api/feed` — فید روزانه: **اخبار پزشکی زنده** + ویدیو/نکته/تبلیغ (هر ۲۴ ساعت تازه‌سازی)
  - مراجع خبری: سیب مگزین، Medscape، Medical News Today، Modern Healthcare، دکتر مایکو
- `GET  /api/jobs` — آگهی‌های شغلی زنده از جابینجا، کارنو و ایران استخدام (فیلترشده برای رشته‌های پزشکی)
